...
void ARTSPawn::SetupPlayerInputComponent(UInputComponent* PlayerInputComponent)
{
	...
	PlayerInputComponent->BindAxis(XAxis, this, &ARTSPawn::XMovement);
	PlayerInputComponent->BindAxis(YAxis, this, &ARTSPawn::YMovement);
	PlayerInputComponent->BindAxis(RotationAxis, this, &ARTSPawn::RotateCamera);
	PlayerInputComponent->BindAxis(ZoomAxis, this, &ARTSPawn::Zoom);
}

void ARTSPawn::XMovement(const float AxisValue)
{
	FVector Movement;
...
void ARTSPawn::YMovement(const float AxisValue)
{
	FVector Movement;
	Movement.X = 0;
...
void ARTSPawn::RotateCamera(float AxisValue)
{
...
void ARTSPawn::Zoom(float AxisValue)
{
	if (AxisValue != 0)
	{
